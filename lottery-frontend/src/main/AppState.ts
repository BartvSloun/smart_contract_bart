...
import { LotteryApi } from "./contract/LotteryApi";
...
let lotteryApi: LotteryApi | undefined;
...
export const setLotteryApi = () => {
  if (currentAccount != undefined) {
    const transactionApi = new TransactionApi(currentAccount, updateContractState);
    lotteryApi = new LotteryApi(transactionApi);
  }
};

export const getLotteryApi = () => {
  return lotteryApi;
};
