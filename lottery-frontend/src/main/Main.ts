...
import { getLotteryApi, isConnected, setContractAddress } from "./AppState";
import {
...
function contractAddressClick() {
  ...
  if (address === undefined) {
    ...
    currentAddress.innerHTML = `Lottery Address: ${address}`;
...
/** Action for the sign lottery button */
function signAction() {
  const api = getLotteryApi();
